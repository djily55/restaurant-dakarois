    ...
    <div className="min-h-screen bg-[#0D0D0D] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12">
        <div
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1600891964092-4316c288032e?w=900&q=80')" }}
        />
          ...
          <div className="mt-10 space-y-4">
            {[
              ...
              <div key={num} className="flex items-center gap-4">
                <div className="w-8 h-8 rounded-full bg-[#C0392B]/20 border border-[#C0392B]/40 flex items-center justify-center text-[#E67E22] text-sm font-bold flex-shrink-0">
                  {num}
                </div>
      ...
      {/* Panneau droit */}
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-[#111]">
        <div className="w-full max-w-md">
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            <div className="w-9 h-9 bg-[#C0392B] rounded-xl flex items-center justify-center">
              <ChefHat size={18} className="text-white" />
            </div>
            <span className="font-bold text-lg text-white">Le Dakarois</span>
          </div>

          {step === "email" ? (
            <>
              <Link to="/login" className="inline-flex items-center gap-2 text-white/40 hover:text-white/70 text-sm mb-8 transition-colors">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="block text-white/70 text-sm font-medium mb-2">Adresse email</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1A1A1A] border border-white/10 rounded-xl pl-11 pr-4 py-3.5 text-white placeholder:text-white/20 text-sm focus:outline-none focus:border-[#C0392B]/60 focus:bg-[#1E1E1E] transition-all"
                    />
                  </div>
                </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-[#1A1A1A] border border-white/5 rounded-xl p-4 text-left mb-8">
                <p className="text-white/50 text-xs leading-relaxed">
                  Si vous ne trouvez pas l'email, vérifiez votre dossier <span className="text-white/70">spam</span> ou{" "}
                  <button
              ...
              <Link to="/" className="block text-center text-white/30 hover:text-white/60 text-xs mt-4 transition-colors">
                ← Retour à l'accueil
              </Link>
            </div>
          )}
